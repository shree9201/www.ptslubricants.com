 ...
 */
/*
 * Copyright (C) Federico Zivolo 2018 Distributed under the MIT License (license
 ...
 */
/*
 * ! Bootstrap v4.1.0 (https://getbootstrap.com/) Copyright 2011-2018 The
 ...
 */
/*
 * ! Waypoints - 4.0.1 Copyright Â© 2011-2016 Caleb Troughton Licensed under
 * the MIT license.
 ...
 * 
 * Copyright 2013, Benjamin Intal http://gambit.ph @bfintal Released under the
 * GPL v2 License
 * 
 * Date: Nov 26, 2013
 */
 ...
 */
/*
 * ! imagesLoaded PACKAGED v3.1.4 JavaScript is all like "You images are done
 * yet or what?" MIT License
 */
(function() {
    function e() {}
...
var TradeZone = function() {
    ...
    var e = $(window).width(),
        ...
        t = function() {
            "use strict";
            var e = jQuery(this),
                i = e.find(".modal-dialog");
            e.css("display", "block"), i.css("margin-top", Math.max(0, (jQuery(window).height() - i.height()) / 2))
        },
        r = function() {
            "use strict";
            e <= 991 && jQuery(".navbar-nav > li > a, .sub-menu > li > a").unbind().on("click", function(e) {
                ...
                jQuery(".menu-close,.full-sidenav").addClass("active"), i()
            ...
            $(".wow").length > 0 && new WOW({
                ...
                function() {
                    if ($(".setResizeMargin").length > 0 && e >= 1280) {
                        var i = $(".container").width(),
                            n = (e - i) / 2;
                        $(".setResizeMargin").css("margin-left", n)
                    }
                    $(".setResizeMarginRight").length > 0 && e >= 1280 && (i = $(".container").width(), n = (e - i) / 2, $(".setResizeMarginRight").css("margin-right", n))
                }(), jQuery(window).on("resize", function() {
                    jQuery(".modal:visible").each(t), a()
                }), jQuery(".modal").on("show.bs.modal", t)
        },
        load: function() {
...
jQuery(document).ready(function() {
    "use strict";
    TradeZone.init(), $('a[data-toggle="tab"]').click(function() {
    ...
    "use strict";
    TradeZone.load(), setTimeout(function() {
